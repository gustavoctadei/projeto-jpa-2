...
//		props.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQL5InnoDBDialect");
        ...
        props.setProperty("hibernate.cache.use_second_level_cache", "true"); //Habilita o Cache de Segundo Nivel, compartilhado entra todos os EntityManagers
        props.setProperty("hibernate.cache.use_query_cache", "true"); //Configuração para ativar Cache de Resultados de Queries

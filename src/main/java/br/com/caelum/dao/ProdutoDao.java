...
//    //Busca com filtros com JPQL puro
...
//        
//        if(categoriaId != null) query.setParameter("pCategoriaId", categoriaId);
//        if(lojaId != null) query.setParameter("pLojaId", lojaId);
//        if(!nome.isEmpty()) query.setParameter("pProdtoNome", nome);
//        
//        return query.getResultList();
//    }
        
    //Busca com Filtros utilizando CriteriaQuery
    public List<Produto> getProdutos(String nome, Integer categoriaId, Integer lojaId) {
